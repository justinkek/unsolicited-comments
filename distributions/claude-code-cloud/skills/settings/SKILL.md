...
```
bash "/opt/unsolicited-comments/distributions/claude-code-cloud/set-setting.sh" <key> <value>
```
...
a setting you want to keep goes in a `UNSOLICITED_COMMENTS_` environment variable on
